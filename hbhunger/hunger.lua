...
if minetest.get_modpath("crops") then
	overwrite("crops:vegetable_stew",12,"crops:clay_bowl")
	overwrite("crops:uncooked_vegetable_stew",2,"crops:clay_bowl")
	overwrite("crops:corn_on_the_cob",6)
	overwrite("crops:melon_slice",3)
	overwrite("crops:green_bean",1)
	overwrite("crops:potato",2)
	overwrite("crops:roasted_pumpkin",4)
	overwrite("crops:tomato",2)
end
